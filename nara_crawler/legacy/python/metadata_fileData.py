...
class FileDataMetadataScanner:
    ...
    def save_results(self, output_dir="/data/metadata_results"):
        """스캔 결과 저장"""
        # /data/metadata_results/fileData 폴더 생성
